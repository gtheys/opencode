---
name: ci-describe-pr
description: Generate comprehensive PR descriptions following repository templates for CI environments. Use when running in a CI/CD pipeline or automated environment where thoughts/ directory is not available.
---

# Generate PR Description (CI Environment)

You are tasked with generating a comprehensive pull request description following the repository's standard template.

This is the CI variant — optimized for automated environments.
