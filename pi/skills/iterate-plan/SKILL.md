---
name: iterate-plan
description: Iterate on existing implementation plans with thorough research and updates. Use when the user wants to modify, update, or refine an existing plan. Trigger on mentions of "update plan", "iterate plan", "modify plan", or "change plan".
---
...
2. **Use skills for research**:
   - `/skill:codebase-locator` - To find relevant files
   - `/skill:codebase-analyzer` - To understand implementation details
   - `/skill:codebase-pattern-finder` - To find similar patterns
   - `/skill:thoughts-locator` - To find related research or decisions
   - `/skill:thoughts-analyzer` - To extract insights from documents
...
5. **Track Progress**:
   - Use markdown checkboxes to track update tasks if complex
