---
name: describe-pr
description: Generate comprehensive PR descriptions following repository templates. Use when the user wants to write or update a PR description. Trigger on mentions of "describe pr", "pr description", "write pr desc", or "update pr".
---
