...
description: Discovers relevant documents in thoughts/ directory. Use when you're in a researching mood and need to figure out if we have random thoughts written down that are relevant to your current research task. Based on the name, this is the `thoughts` equivalent of `codebase-locator`.
---
